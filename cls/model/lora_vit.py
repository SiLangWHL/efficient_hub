...
class LoRA_ViT_timm(nn.Module):
    def __init__(self, vit_model: timm_ViT, r = 4, lora_layer=None):
...
def get_model(version="vit_base_patch16_clip_224.laion2b_ft_in12k_in1k", r=4):
    model = timm.create_model(version, pretrained=True)
    lora_model = LoRA_ViT_timm(vit_model=model, r=r)
    return lora_model
